  ...
  _createClass(PlayScene, [{
    ...
    value: function update(time, delta) {
      if (this.keyboard.D.isDown) {
        this.player.setVelocityX(60); //this.player.play('right',true)
        //this.player.play('netural',true)
      }

      if (this.keyboard.W.isDown) {
        this.player.setVelocityY(-60); //this.player.play('netural',true)
      }
      ...
      if (this.keyboard.A.isDown) {
        this.player.setVelocityX(-60); //this.player.play('left',true)
        //this.player.play('netural',true)
      }
